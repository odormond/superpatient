...
class MainFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.site = wx.Choice(self.panel_1, wx.ID_ANY, choices=[])
        ...
        self.Bind(wx.EVT_CHOICE, self.on_search, self.site)
    ...
    def __set_properties(self):
        ...
        self.payments.AppendColumn("Site", format=wx.LIST_FORMAT_LEFT, width=-1)
    ...
    def __do_layout(self):
        ...
        grid_sizer_1.Add(wx.StaticText(self.panel_1, wx.ID_ANY, "Thérapeute"), 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1.Add(self.therapeute, 0, wx.EXPAND, 0)
        grid_sizer_1.Add(wx.StaticText(self.panel_1, wx.ID_ANY, "Facture dès le"), 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1.Add(self.filter_start, 0, wx.EXPAND, 0)
        grid_sizer_1.Add(self.button_6, 0, 0, 0)
        grid_sizer_1.Add(wx.StaticText(self.panel_1, wx.ID_ANY, "Moyen de paiement"), 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1.Add(self.payment_method, 0, wx.EXPAND, 0)
        grid_sizer_1.Add(wx.StaticText(self.panel_1, wx.ID_ANY, "Facture jusqu'au"), 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1.Add(self.filter_end, 0, wx.EXPAND, 0)
        grid_sizer_1.Add(self.button_7, 0, 0, 0)
        grid_sizer_1.Add(wx.StaticText(self.panel_1, wx.ID_ANY, "Status de la facture"), 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1.Add(self.bill_status, 0, wx.EXPAND, 0)
        grid_sizer_1.Add(wx.StaticText(self.panel_1, wx.ID_ANY, "Site"), 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1.Add(self.site, 0, wx.EXPAND, 0)
        grid_sizer_1.Add((0, 0), 0, 0, 0)
        grid_sizer_1.Add(wx.StaticText(self.panel_1, wx.ID_ANY, "Nom"), 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1.Add(self.filter_lastname, 0, wx.EXPAND, 0)
        grid_sizer_1.Add(wx.StaticText(self.panel_1, wx.ID_ANY, "Prénom"), 0, wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        grid_sizer_2.Add(wx.StaticText(self.panel_1, wx.ID_ANY, "# entrées"), 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_2.Add(self.payments_count, 0, wx.EXPAND, 0)
        grid_sizer_2.Add(wx.StaticText(self.panel_1, wx.ID_ANY, "Total factures"), 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_2.Add(self.total_bills, 0, wx.EXPAND, 0)
        grid_sizer_2.Add((0, 0), 0, 0, 0)
        grid_sizer_2.Add((0, 0), 0, 0, 0)
        grid_sizer_2.Add(wx.StaticText(self.panel_1, wx.ID_ANY, "Total frais de rappels"), 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_2.Add(self.total_reminder_costs, 0, wx.EXPAND, 0)
        grid_sizer_2.Add((0, 0), 0, 0, 0)
        grid_sizer_2.Add((0, 0), 0, 0, 0)
        grid_sizer_2.Add(wx.StaticText(self.panel_1, wx.ID_ANY, "Total"), 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_2.Add(self.total, 0, wx.EXPAND, 0)
        grid_sizer_2.AddGrowableCol(1)
        grid_sizer_2.AddGrowableCol(3)
        sizer_1.Add(grid_sizer_2, 0, wx.EXPAND, 0)
        sizer_2.Add(wx.StaticText(self.panel_1, wx.ID_ANY, "Paiement reçu le"), 0, wx.ALIGN_CENTER_VERTICAL, 0)
...
class RemindersManagementDialog(wx.Dialog):
    ...
    def __set_properties(self):
        ...
        self.reminders.AppendColumn("Site", format=wx.LIST_FORMAT_LEFT, width=-1)
...
class StatisticsDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.site = wx.Choice(self, wx.ID_ANY, choices=[])
        ...
        self.Bind(wx.EVT_CHOICE, self.update_display, self.site)
