...
class MainFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        if 'MANAGE_COSTS' in ACCESS_RIGHTS:
            ...
            self.Bind(wx.EVT_MENU, self.on_manage_tariffs, id=item.GetId())
            item = admin_menu.Append(wx.ID_ANY, "Gestion des majorations", "")
            self.Bind(wx.EVT_MENU, self.on_manage_majorations, id=item.GetId())
            item = admin_menu.Append(wx.ID_ANY, "Gestion des frais administratifs", "")
            self.Bind(wx.EVT_MENU, self.on_manage_admin_costs, id=item.GetId())
    ...
    def on_manage_tariffs(self, event):
        print("Event handler 'on_manage_tariffs' not implemented!")
        event.Skip()

    def on_manage_majorations(self, event):
        print("Event handler 'on_manage_majorations' not implemented!")
        event.Skip()

    def on_manage_admin_costs(self, event):
        print("Event handler 'on_manage_admin_costs' not implemented!")
        event.Skip()
...
class ManageCostsDialog(wx.Dialog):
    ...
    def __set_properties(self):
        self.SetTitle("Gérer les ???")
        self.costs_list.AppendColumn("Description", format=wx.LIST_FORMAT_LEFT, width=-1)
        self.costs_list.AppendColumn("Prix", format=wx.LIST_FORMAT_LEFT, width=-1)
    ...
    def __do_layout(self):
        ...
        sizer_4.Add(self.costs_list, 1, wx.EXPAND, 0)
        label_4 = wx.StaticText(self, wx.ID_ANY, "Description")
        grid_sizer_2.Add(label_4, 0, wx.ALIGN_BOTTOM, 0)
        label_5 = wx.StaticText(self, wx.ID_ANY, "Prix")
        grid_sizer_2.Add(label_5, 0, wx.ALIGN_BOTTOM, 0)
        grid_sizer_2.Add((0, 0), 0, 0, 0)
        grid_sizer_2.Add(self.description, 0, wx.EXPAND, 0)
        grid_sizer_2.Add(self.price, 0, wx.EXPAND, 0)
        sizer_5.Add(self.add_btn, 0, wx.EXPAND, 0)
        sizer_5.Add(self.change_btn, 0, wx.EXPAND, 0)
        grid_sizer_2.Add(sizer_5, 1, wx.EXPAND, 0)
        grid_sizer_2.Add((0, 0), 0, 0, 0)
        grid_sizer_2.Add((0, 0), 0, 0, 0)
        grid_sizer_2.Add(self.remove_btn, 0, wx.EXPAND, 0)
        grid_sizer_2.AddGrowableCol(0)
        sizer_4.Add(grid_sizer_2, 0, wx.EXPAND, 0)
...
class PatientDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.child = wx.RadioButton(self.panel_1, wx.ID_ANY, "E")
        ...
        self.private_address = wx.TextCtrl(self.panel_1, wx.ID_ANY, "", style=wx.TE_DONTWRAP | wx.TE_MULTILINE)
    ...
    def __do_layout(self):
        ...
        sizer_15.Add(self.child, 1, wx.EXPAND, 0)
        ...
        label_28 = wx.StaticText(self.panel_1, wx.ID_ANY, "Date d'ouverture")
        grid_sizer_7.Add(label_28, (3, 2), (1, 1), wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        label_21 = wx.StaticText(self.panel_1, wx.ID_ANY, "Adresse privée")
        grid_sizer_7.Add(label_21, (8, 0), (1, 1), wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_7.Add(self.private_address, (8, 1), (2, 1), wx.EXPAND, 0)
        ...
        grid_sizer_7.Add(label_22, (10, 0), (1, 1), wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_7.Add(self.complementary_insurance, (10, 1), (1, 1), wx.EXPAND, 0)
        label_23 = wx.StaticText(self.panel_1, wx.ID_ANY, "Profession")
        grid_sizer_7.Add(label_23, (11, 0), (1, 1), wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_7.Add(self.profession, (11, 1), (1, 1), wx.EXPAND, 0)
        label_33 = wx.StaticText(self.panel_1, wx.ID_ANY, "État civil")
        grid_sizer_7.Add(label_33, (11, 2), (1, 1), wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_7.Add(self.civil_status, (11, 3), (1, 1), wx.EXPAND, 0)
        label_24 = wx.StaticText(self.panel_1, wx.ID_ANY, "Envoyé par")
        grid_sizer_7.Add(label_24, (12, 0), (1, 1), wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_7.Add(self.sent_by, (12, 1), (1, 1), wx.EXPAND, 0)
        label_25 = wx.StaticText(self.panel_1, wx.ID_ANY, "Remarques")
        grid_sizer_7.Add(label_25, (13, 0), (1, 1), wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_7.Add(self.remarks, (13, 1), (2, 3), wx.EXPAND, 0)
        ...
        grid_sizer_7.AddGrowableRow(13)
...
class ConsultationDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.price = wx.Choice(self.panel_3, wx.ID_ANY, choices=[])
        self.markup = wx.Choice(self.panel_3, wx.ID_ANY, choices=[])
        self.admin_cost = wx.Choice(self.panel_3, wx.ID_ANY, choices=[])
        self.payment_method = wx.RadioBox(self.panel_3, wx.ID_ANY, "Moyen de payement", choices=PAYMENT_METHODS, majorDimension=1, style=wx.RA_SPECIFY_ROWS)
        self.payment_date = wx.StaticText(self.panel_3, wx.ID_ANY, "")
        self.save_close_btn = wx.Button(self, wx.ID_ANY, "Enregistrer et fermer")
        self.cancel_btn = wx.Button(self, wx.ID_ANY, "Annuler")
        self.ok_btn = wx.Button(self, wx.ID_ANY, "OK")
        self.print_btn = wx.Button(self, wx.ID_ANY, "Réimprimmer")
        self.show_all_consultations_btn = wx.Button(self, wx.ID_ANY, "Toutes les consultations")

        self.__set_properties()
        self.__do_layout()

        self.Bind(wx.EVT_BUTTON, self.on_save, self.save_close_btn)
    ...
    def __do_layout(self):
        ...
        cost_sizer.Add(wx.StaticText(self.panel_3, wx.ID_ANY, "Durée / Prix"), 0, wx.ALIGN_CENTER_VERTICAL, 0)
        cost_sizer.Add(self.price, 0, wx.EXPAND, 0)
        cost_sizer.Add(wx.StaticText(self.panel_3, wx.ID_ANY, "Majoration"), 0, wx.ALIGN_CENTER_VERTICAL, 0)
        cost_sizer.Add(self.markup, 0, wx.EXPAND, 0)
        cost_sizer.Add(wx.StaticText(self.panel_3, wx.ID_ANY, "Frais administratif"), 0, wx.ALIGN_CENTER_VERTICAL, 0)
        cost_sizer.Add(self.admin_cost, 0, wx.EXPAND, 0)
        cost_sizer.AddGrowableCol(1)
        left_sizer.Add(cost_sizer, 0, wx.EXPAND, 0)
        ...
        central_sizer.Add(self.payment_method, 0, wx.EXPAND, 0)
        central_sizer.Add(self.payment_date, 0, wx.EXPAND, 0)
        ...
        button_sizer.Add(self.save_close_btn, 0, 0, 0)
        button_sizer.Add(self.cancel_btn, 0, 0, 0)
        button_sizer.Add(self.ok_btn, 0, 0, 0)
        button_sizer.Add(self.print_btn, 0, 0, 0)
    ...
    def __do_not_layout(self):
        sizer_25 = wx.BoxSizer(wx.VERTICAL)
        sizer_26 = wx.BoxSizer(wx.HORIZONTAL)
        grid_sizer_9 = wx.GridBagSizer(2, 2)
        grid_sizer_10 = wx.FlexGridSizer(3, 2, 0, 5)
        sizer_22 = wx.BoxSizer(wx.HORIZONTAL)
        label_35 = wx.StaticText(self.panel_3, wx.ID_ANY, "Motif(s) de consultation")
        sizer_22.Add(label_35, 1, 0, 0)
        sizer_22.Add(self.illness, 0, 0, 0)
        sizer_22.Add(self.accident, 0, 0, 5)
        sizer_22.Add((20, 10), 0, 0, 0)
        grid_sizer_9.Add(sizer_22, (0, 0), (1, 1), wx.EXPAND, 0)
        label_36 = wx.StaticText(self.panel_3, wx.ID_ANY, "État général")
        grid_sizer_9.Add(label_36, (0, 1), (1, 1), 0, 0)
        label_37 = wx.StaticText(self.panel_3, wx.ID_ANY, "Examens paracliniques")
        grid_sizer_9.Add(label_37, (0, 2), (1, 1), 0, 0)
        grid_sizer_9.Add(self.reason, (1, 0), (1, 1), wx.EXPAND, 0)
        grid_sizer_9.Add(self.general_state, (1, 1), (1, 1), wx.EXPAND, 0)
        grid_sizer_9.Add(self.paraclinic_exams, (1, 2), (3, 1), wx.EXPAND, 0)
        label_38 = wx.StaticText(self.panel_3, wx.ID_ANY, "Antécédents personnels")
        grid_sizer_9.Add(label_38, (2, 0), (1, 1), 0, 0)
        label_39 = wx.StaticText(self.panel_3, wx.ID_ANY, "Antécédents familiaux")
        grid_sizer_9.Add(label_39, (2, 1), (1, 1), 0, 0)
        grid_sizer_9.Add(self.medical_background, (3, 0), (1, 1), wx.EXPAND, 0)
        grid_sizer_9.Add(self.family_history, (3, 1), (1, 1), wx.EXPAND, 0)
        label_40 = wx.StaticText(self.panel_3, wx.ID_ANY, "Thorax")
        grid_sizer_9.Add(label_40, (4, 0), (1, 1), 0, 0)
        label_41 = wx.StaticText(self.panel_3, wx.ID_ANY, "Abdomen")
        grid_sizer_9.Add(label_41, (4, 1), (1, 1), 0, 0)
        label_42 = wx.StaticText(self.panel_3, wx.ID_ANY, "Examen physique")
        grid_sizer_9.Add(label_42, (4, 2), (1, 1), 0, 0)
        grid_sizer_9.Add(self.thorax, (5, 0), (1, 1), wx.EXPAND, 0)
        grid_sizer_9.Add(self.abdomen, (5, 1), (1, 1), wx.EXPAND, 0)
        grid_sizer_9.Add(self.physical_exam, (5, 2), (3, 1), wx.EXPAND, 0)
        label_43 = wx.StaticText(self.panel_3, wx.ID_ANY, "Tête et cou")
        grid_sizer_9.Add(label_43, (6, 0), (1, 1), 0, 0)
        label_44 = wx.StaticText(self.panel_3, wx.ID_ANY, "Membres supérieurs")
        grid_sizer_9.Add(label_44, (6, 1), (1, 1), 0, 0)
        grid_sizer_9.Add(self.head_neck, (7, 0), (1, 1), wx.EXPAND, 0)
        grid_sizer_9.Add(self.upper_limbs, (7, 1), (1, 1), wx.EXPAND, 0)
        label_45 = wx.StaticText(self.panel_3, wx.ID_ANY, "Membres inférieurs")
        grid_sizer_9.Add(label_45, (8, 0), (1, 1), 0, 0)
        label_46 = wx.StaticText(self.panel_3, wx.ID_ANY, "Neuro, vascul, dermato, endocrino, lymph")
        grid_sizer_9.Add(label_46, (8, 1), (1, 1), 0, 0)
        label_47 = wx.StaticText(self.panel_3, wx.ID_ANY, "Important")
        label_47.SetForegroundColour(wx.Colour(255, 0, 0))
        grid_sizer_9.Add(label_47, (8, 2), (1, 1), 0, 0)
        grid_sizer_9.Add(self.lower_limbs, (9, 0), (1, 1), wx.EXPAND, 0)
        grid_sizer_9.Add(self.other, (9, 1), (1, 1), wx.EXPAND, 0)
        grid_sizer_9.Add(self.important, (9, 2), (1, 1), wx.EXPAND, 0)
        label_48 = wx.StaticText(self.panel_3, wx.ID_ANY, "Anamnèse ostéopathique")
        grid_sizer_9.Add(label_48, (10, 0), (1, 1), 0, 0)
        label_49 = wx.StaticText(self.panel_3, wx.ID_ANY, "Traitement")
        label_49.SetForegroundColour(wx.Colour(35, 142, 35))
        ...
        grid_sizer_9.Add(label_51, (12, 0), (1, 1), 0, 0)
        label_52 = wx.StaticText(self.panel_3, wx.ID_ANY, "Thérapeute")
        grid_sizer_9.Add(label_52, (12, 1), (1, 1), 0, 0)
        label_53 = wx.StaticText(self.panel_3, wx.ID_ANY, "Paye ?")
        grid_sizer_9.Add(label_53, (12, 2), (1, 1), 0, 0)
        grid_sizer_9.Add(self.consultation_date, (13, 0), (1, 1), wx.EXPAND, 0)
        grid_sizer_9.Add(self.therapeute, (13, 1), (1, 1), wx.EXPAND, 0)
        grid_sizer_9.Add(self.payment, (13, 2), (4, 1), wx.EXPAND, 0)
        label_54 = wx.StaticText(self.panel_3, wx.ID_ANY, "Durée / Prix")
        grid_sizer_10.Add(label_54, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_10.Add(self.price, 0, wx.EXPAND, 0)
        label_55 = wx.StaticText(self.panel_3, wx.ID_ANY, "Majoration")
        grid_sizer_10.Add(label_55, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_10.Add(self.markup, 0, wx.EXPAND, 0)
        label_56 = wx.StaticText(self.panel_3, wx.ID_ANY, "Frais administratif")
        grid_sizer_10.Add(label_56, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_10.Add(self.admin_cost, 0, wx.EXPAND, 0)
        grid_sizer_10.AddGrowableCol(1)
        grid_sizer_9.Add(grid_sizer_10, (14, 0), (3, 1), wx.EXPAND, 0)
        grid_sizer_9.Add(self.payment_method, (14, 1), (2, 1), wx.EXPAND, 0)
        grid_sizer_9.Add(self.payment_date, (16, 1), (1, 1), wx.EXPAND, 0)
        self.panel_3.SetSizer(grid_sizer_9)
        grid_sizer_9.AddGrowableRow(1)
        grid_sizer_9.AddGrowableRow(3)
        grid_sizer_9.AddGrowableRow(5)
        grid_sizer_9.AddGrowableRow(7)
        grid_sizer_9.AddGrowableRow(9)
        grid_sizer_9.AddGrowableRow(11)
        grid_sizer_9.AddGrowableCol(0)
        grid_sizer_9.AddGrowableCol(1)
        grid_sizer_9.AddGrowableCol(2)
        sizer_25.Add(self.panel_3, 1, wx.ALL | wx.EXPAND, 5)
        sizer_26.Add(self.save_close_btn, 0, 0, 0)
        sizer_26.Add(self.cancel_btn, 0, 0, 0)
        sizer_26.Add(self.ok_btn, 0, 0, 0)
        sizer_26.Add(self.print_btn, 0, 0, 0)
        sizer_26.Add(self.show_all_consultations_btn, 0, 0, 0)
        sizer_25.Add(sizer_26, 0, wx.ALIGN_CENTER_HORIZONTAL, 0)
        self.SetSizer(sizer_25)
        sizer_25.Fit(self)
        sizer_25.SetSizeHints(self)
        self.Layout()
