...
class BillDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.street = wx.TextCtrl(self, wx.ID_ANY, "")
        self.zip = wx.TextCtrl(self, wx.ID_ANY, "")
        self.city = wx.TextCtrl(self, wx.ID_ANY, "")
        self.birthdate = wx.TextCtrl(self, wx.ID_ANY, "")
        ...
        self.mandant = wx.TextCtrl(self, wx.ID_ANY, "")
        self.diagnostic = wx.TextCtrl(self, wx.ID_ANY, "")
    ...
    def __set_properties(self):
        ...
        self.patient_id.Disable()
        self.avs_no.Disable()
        self.cada_no.Disable()
        self.insurance_no.Disable()
        self.copy.SetSelection(0)
        self.reimbursement_type.Disable()
        self.reimbursement_type.SetSelection(0)
        self.contract_no.Disable()
        self.reason.SetSelection(0)
        self.therapy.Disable()
        self.therapy.SetSelection(0)
        self.point_value.Disable()
        self.vat_enabled.Disable()
    ...
    def __do_layout(self):
        ...
        grid_sizer_2.Add(wx.StaticText(self, wx.ID_ANY, "Prénom"), (3, 1), (1, 1), 0, 0)
        ...
        grid_sizer_2.Add(wx.StaticText(self, wx.ID_ANY, "Localité"), (6, 1), (1, 1), 0, 0)
        ...
        grid_sizer_2.Add(wx.StaticText(self, wx.ID_ANY, "N° patient"), (12, 1), (1, 1), 0, 0)
        grid_sizer_2.Add(self.patient_id, (12, 2), (1, 1), wx.EXPAND, 0)
        grid_sizer_2.Add(wx.StaticText(self, wx.ID_ANY, "N° AVS"), (13, 1), (1, 1), 0, 0)
        grid_sizer_2.Add(self.avs_no, (13, 2), (1, 1), wx.EXPAND, 0)
        grid_sizer_2.Add(wx.StaticText(self, wx.ID_ANY, "N° CADA"), (14, 1), (1, 1), 0, 0)
        grid_sizer_2.Add(self.cada_no, (14, 2), (1, 1), wx.EXPAND, 0)
        grid_sizer_2.Add(wx.StaticText(self, wx.ID_ANY, "N° assuré"), (15, 1), (1, 1), 0, 0)
        ...
        grid_sizer_2.Add(wx.StaticText(self, wx.ID_ANY, "N° contrat"), (19, 1), (1, 1), 0, 0)
        ...
        label_29 = wx.StaticText(self, wx.ID_ANY, "Thérapie")
        ...
        self.positions_footer_sizer.Add(wx.StaticText(self, wx.ID_ANY, "Moyen de paiement"), 0, wx.ALIGN_CENTER_VERTICAL | wx.RIGHT, 5)
