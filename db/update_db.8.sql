...
ALTER TABLE consultations ADD COLUMN frais_admin_cts integer AFTER majoration_txt, ADD COLUMN frais_admin_txt text AFTER frais_admin_cts, ADD COLUMN heure_consult time AFTER date_consult;
