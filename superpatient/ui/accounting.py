...
class MainFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.button_6 = wx.Button(self.panel_1, wx.ID_ANY, u"\U0001f4c5", style=wx.BU_EXACTFIT)
        ...
        self.button_7 = wx.Button(self.panel_1, wx.ID_ANY, u"\U0001f4c5", style=wx.BU_EXACTFIT)
        ...
        self.button_8 = wx.Button(self.panel_1, wx.ID_ANY, u"\U0001f50e", style=wx.BU_EXACTFIT)
        ...
        self.total_consultations = wx.TextCtrl(self.panel_1, wx.ID_ANY, "", style=wx.TE_READONLY)
        self.total_majorations = wx.TextCtrl(self.panel_1, wx.ID_ANY, "", style=wx.TE_READONLY)
        self.total_admin_costs = wx.TextCtrl(self.panel_1, wx.ID_ANY, "", style=wx.TE_READONLY)
        self.total_reminder_costs = wx.TextCtrl(self.panel_1, wx.ID_ANY, "", style=wx.TE_READONLY)
        self.total = wx.TextCtrl(self.panel_1, wx.ID_ANY, "", style=wx.TE_READONLY)
        self.payment_date = wx.TextCtrl(self.panel_1, wx.ID_ANY, "")
        self.button_1 = wx.Button(self.panel_1, wx.ID_ANY, u"Marquer payé")
        self.button_2 = wx.Button(self.panel_1, wx.ID_ANY, u"Réimprimmer")
        self.button_3 = wx.Button(self.panel_1, wx.ID_ANY, u"Marquer imprimmé")
        self.button_4 = wx.Button(self.panel_1, wx.ID_ANY, u"Marquer envoyé")
        self.button_5 = wx.Button(self.panel_1, wx.ID_ANY, u"Marquer abandonné")
    ...
    def __set_properties(self):
        ...
        self.payments.AppendColumn(u"Prénom", format=wx.LIST_FORMAT_LEFT, width=-1)
        self.payments.AppendColumn("Consultation du", format=wx.LIST_FORMAT_LEFT, width=-1)
        self.payments.AppendColumn("Prix", format=wx.LIST_FORMAT_LEFT, width=-1)
        self.payments.AppendColumn(u"Payé le", format=wx.LIST_FORMAT_LEFT, width=-1)
    ...
    def __do_layout(self):
        ...
        label_1 = wx.StaticText(self.panel_1, wx.ID_ANY, u"Thérapeute")
        grid_sizer_1.Add(label_1, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1.Add(self.therapeute, 0, wx.EXPAND, 0)
        label_2 = wx.StaticText(self.panel_1, wx.ID_ANY, u"Consultations dès le")
        ...
        label_4 = wx.StaticText(self.panel_1, wx.ID_ANY, "Moyen de payement")
        grid_sizer_1.Add(label_4, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1.Add(self.payment_method, 0, wx.EXPAND, 0)
        label_3 = wx.StaticText(self.panel_1, wx.ID_ANY, u"Consultation jusqu'au")
        ...
        label_5 = wx.StaticText(self.panel_1, wx.ID_ANY, u"Prénom")
        ...
        label_8 = wx.StaticText(self.panel_1, wx.ID_ANY, u"# entrées")
        grid_sizer_2.Add(label_8, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_2.Add(self.payments_count, 0, wx.EXPAND, 0)
        label_9 = wx.StaticText(self.panel_1, wx.ID_ANY, "Total consultations")
        grid_sizer_2.Add(label_9, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_2.Add(self.total_consultations, 0, wx.EXPAND, 0)
        grid_sizer_2.Add((0, 0), 0, 0, 0)
        grid_sizer_2.Add((0, 0), 0, 0, 0)
        label_10 = wx.StaticText(self.panel_1, wx.ID_ANY, "Total majorations")
        grid_sizer_2.Add(label_10, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_2.Add(self.total_majorations, 0, wx.EXPAND, 0)
        grid_sizer_2.Add((0, 0), 0, 0, 0)
        grid_sizer_2.Add((0, 0), 0, 0, 0)
        label_11 = wx.StaticText(self.panel_1, wx.ID_ANY, "Total frais administratif")
        grid_sizer_2.Add(label_11, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_2.Add(self.total_admin_costs, 0, wx.EXPAND, 0)
        grid_sizer_2.Add((0, 0), 0, 0, 0)
        grid_sizer_2.Add((0, 0), 0, 0, 0)
        ...
        label_14 = wx.StaticText(self.panel_1, wx.ID_ANY, u"Payement reçu le")
...
class RemindersManagementDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.button_9 = wx.Button(self, wx.ID_ANY, u"Générer les rappels")
    ...
    def __set_properties(self):
        ...
        self.reminders.AppendColumn(u"Prénom", format=wx.LIST_FORMAT_LEFT, width=-1)
        self.reminders.AppendColumn("Consultation du", format=wx.LIST_FORMAT_LEFT, width=-1)
    ...
    def __do_layout(self):
        ...
        label_16 = wx.StaticText(self, wx.ID_ANY, u"Consultations ou rappels jusqu'au", style=wx.ALIGN_RIGHT)
...
class ImportDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        super().__init__(*args, **kwds)
        self.volume_in_order = wx.StaticText(self, wx.ID_ANY, "0", style=wx.ALIGN_CENTER)
        self.revenue_in_order = wx.StaticText(self, wx.ID_ANY, "0.00 CHF", style=wx.ALIGN_CENTER)
        self.details_in_order = wx.Button(self, wx.ID_ANY, u"Détails")
        self.volume_wrong_amount = wx.StaticText(self, wx.ID_ANY, "0", style=wx.ALIGN_CENTER)
        self.revenue_wrong_amount = wx.StaticText(self, wx.ID_ANY, "0.00 CHF", style=wx.ALIGN_CENTER)
        self.details_wrong_amount = wx.Button(self, wx.ID_ANY, u"Détails")
        self.volume_already_paid = wx.StaticText(self, wx.ID_ANY, "0", style=wx.ALIGN_CENTER)
        self.revenue_already_paid = wx.StaticText(self, wx.ID_ANY, "0.00 CHF", style=wx.ALIGN_CENTER)
        self.details_already_paid = wx.Button(self, wx.ID_ANY, u"Détails")
        self.volume_not_found = wx.StaticText(self, wx.ID_ANY, "0", style=wx.ALIGN_CENTER)
        self.revenue_not_found = wx.StaticText(self, wx.ID_ANY, "0.00 CHF", style=wx.ALIGN_CENTER)
        self.details_not_found = wx.Button(self, wx.ID_ANY, u"Détails")
        self.volume_ignored = wx.StaticText(self, wx.ID_ANY, "0", style=wx.ALIGN_CENTER)
        self.details_ignored = wx.Button(self, wx.ID_ANY, u"Détails")
        self.button_11 = wx.Button(self, wx.ID_ANY, u"Valider l'import")
    ...
    def __set_properties(self):
        self.SetTitle(u"Résumé de l'import")

    def __do_layout(self):
        sizer_9 = wx.BoxSizer(wx.VERTICAL)
        sizer_10 = wx.BoxSizer(wx.HORIZONTAL)
        grid_sizer_3 = wx.FlexGridSizer(6, 4, 0, 0)
        label_33 = wx.StaticText(self, wx.ID_ANY, "Payements")
        grid_sizer_3.Add(label_33, 0, wx.ALIGN_BOTTOM | wx.ALIGN_RIGHT, 0)
        label_17 = wx.StaticText(self, wx.ID_ANY, "Volume", style=wx.ALIGN_CENTER)
        grid_sizer_3.Add(label_17, 0, wx.ALIGN_BOTTOM | wx.ALIGN_CENTER_HORIZONTAL, 0)
        label_18 = wx.StaticText(self, wx.ID_ANY, "Revenue", style=wx.ALIGN_CENTER)
        ...
        grid_sizer_3.Add(self.volume_in_order, 0, wx.ALIGN_CENTER, 0)
        grid_sizer_3.Add(self.revenue_in_order, 0, wx.ALIGN_CENTER, 0)
        ...
        grid_sizer_3.Add(self.volume_wrong_amount, 0, wx.ALIGN_CENTER, 0)
        grid_sizer_3.Add(self.revenue_wrong_amount, 0, wx.ALIGN_CENTER, 0)
        grid_sizer_3.Add(self.details_wrong_amount, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        label_21 = wx.StaticText(self, wx.ID_ANY, u"Déjà encaissés", style=wx.ALIGN_RIGHT)
        grid_sizer_3.Add(label_21, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT, 0)
        grid_sizer_3.Add(self.volume_already_paid, 0, wx.ALIGN_CENTER, 0)
        grid_sizer_3.Add(self.revenue_already_paid, 0, wx.ALIGN_CENTER, 0)
        grid_sizer_3.Add(self.details_already_paid, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        label_22 = wx.StaticText(self, wx.ID_ANY, u"Non trouvés", style=wx.ALIGN_RIGHT)
        grid_sizer_3.Add(label_22, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT, 0)
        grid_sizer_3.Add(self.volume_not_found, 0, wx.ALIGN_CENTER, 0)
        grid_sizer_3.Add(self.revenue_not_found, 0, wx.ALIGN_CENTER, 0)
        grid_sizer_3.Add(self.details_not_found, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        label_23 = wx.StaticText(self, wx.ID_ANY, u"Ignorés", style=wx.ALIGN_RIGHT)
        grid_sizer_3.Add(label_23, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT, 0)
        grid_sizer_3.Add(self.volume_ignored, 0, wx.ALIGN_CENTER, 0)
        grid_sizer_3.Add((0, 0), 0, 0, 0)
