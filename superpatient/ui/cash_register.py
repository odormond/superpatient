...
class MainFrame(wx.Frame):
    ...
    def __set_properties(self):
        ...
        self.SetTitle(u"Vérification/Confirmation finale de paiement")
        ...
        self.payments.AppendColumn(u"Thérapeute", format=wx.LIST_FORMAT_LEFT, width=-1)
        ...
        self.payments.AppendColumn(u"Payé par", format=wx.LIST_FORMAT_LEFT, width=-1)
    ...
    def __do_layout(self):
        ...
        label_3 = wx.StaticText(self, wx.ID_ANY, u"Thérapeute")
        ...
        label_5 = wx.StaticText(self, wx.ID_ANY, "Moyen de payement", style=wx.ALIGN_RIGHT)
